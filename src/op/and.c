...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/03/06 00:38:22 by jlemahie          #+#    #+#             */
/*   Updated: 2019/03/07 23:40:48 by jlemahie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/proto.h"

static int	ft_supp_and(t_env *p, t_proc *c, t_args args, int tmp)
{
	int offset;
